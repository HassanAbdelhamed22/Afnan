...
export const MAX_CATEGORY_IMAGE_BYTES = 8 * 1024 * 1024;
export const CATEGORY_IMAGE_TYPES = CUSTOM_REQUEST_IMAGE_TYPES;
...
export const createUploadIntentSchema = z.object({
  ...
  purpose: z.enum(["CATEGORY_IMAGE", "CUSTOM_REQUEST_REFERENCE", "PRODUCT_IMAGE"]).default("CUSTOM_REQUEST_REFERENCE"),
